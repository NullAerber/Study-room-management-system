...
if($result->num_rows > 0)
{
	...
	while($row = mysqli_fetch_array($result))//获取一行数据并存入一个数组
	{
		...
		{
		    $sqlupdateuser = "UPDATE `userinfo` SET `Seat_state`='0' WHERE `Username` = '$username'";
...
<?php echo "选择座位：";?>
<select name="fullid">
<option value="021">1号座位</option>
<option value="022">2号座位</option>
<option value="023">3号座位</option>
<option value="024">4号座位</option>
<option value="025">5号座位</option>
<option value="026">6号座位</option>
<option value="027">7号座位</option>
<option value="028">8号座位</option>
<option value="029">9号座位</option>
<option value="0210">10号座位</option>
<option value="0211">11号座位</option>
<option value="0212">12号座位</option>
<option value="0213">13号座位</option>
<option value="0214">14号座位</option>
<option value="0215">15号座位</option>
<option value="0216">16号座位</option>
<option value="0217">17号座位</option>
<option value="0218">18号座位</option>
<option value="0219">19号座位</option>
<option value="0220">20号座位</option>
<option value="0221">21号座位</option>
<option value="0222">22号座位</option>
<option value="0223">23号座位</option>
<option value="0224">24号座位</option>
<option value="0225">25号座位</option>
</select>
